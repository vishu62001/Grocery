...
<div className="footer-content">
    <div className="footer-content-left">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi voluptate, at recusandae voluptates veniam alias provident nostrum ipsum animi in officia illo aliquam similique tenetur dolores!</p>
    ...
    <div className="footer-content-right">
        <h2>Contact Us</h2>
        <ul>
            <li>+1-212-313-4141</li>
            <li>contact@vgrocery.com</li>
        </ul>
    </div>
...
<hr></hr>
<p className='footer-copyright'>© 2024 V-Grocery. All rights reserved.</p>
    </div>
  )
}
